      ...
      while (V > 0 && cont <= 200 && Pontos <= 10) {
              ...
              if (u < i) {
                if (v < j) {
                  ...
                  if (v > j) {
                    mira_y = (i - u);
                    mira_x = (v - j);
                    if ((mira_y - MAGIC_NUMBER_3) <= mira_x
                        && (mira_y + MAGIC_NUMBER_3) >= mira_x) {
                      shot = 5;
                    } else {
                      if (mira_x == 1) {
                        shot = 6;
        ...
        System.out.println(
            "|"
                ...
                + P[MAGIC_NUMBER_3][2]
                + "|"
                + P[MAGIC_NUMBER_3][MAGIC_NUMBER_3]
                + "|"
                + P[MAGIC_NUMBER_3][4]
                + "|"
                + P[MAGIC_NUMBER_3][5]
                ...
                + P[MAGIC_NUMBER_3][11]
                + "|"
                + P[MAGIC_NUMBER_3][MAGIC_NUMBER_12]
                + "|"
                + P[MAGIC_NUMBER_3][13]
                + "|"
                + P[MAGIC_NUMBER_3][14]
        ...
        System.out.println(
            "|"
                ...
                + P[MAGIC_NUMBER_12][2]
                + "|"
                + P[MAGIC_NUMBER_12][MAGIC_NUMBER_3]
                + "|"
                + P[MAGIC_NUMBER_12][4]
                + "|"
                + P[MAGIC_NUMBER_12][5]
                ...
                + P[MAGIC_NUMBER_12][9]
                + "|"
                + P[MAGIC_NUMBER_12][10]
                + "|"
                + P[MAGIC_NUMBER_12][11]
                + "|"
                + P[MAGIC_NUMBER_12][MAGIC_NUMBER_12]
                + "|"
                + P[MAGIC_NUMBER_12][13]
                + "|"
                + P[MAGIC_NUMBER_12][14]
                + "|"
                + P[MAGIC_NUMBER_12][15]
                + "|"
                + P[MAGIC_NUMBER_12][16]
                + "|"
                + P[MAGIC_NUMBER_12][17]
                + "|"
                + P[MAGIC_NUMBER_12][18]
                + "|");
        System.out.println(
            "-----------------------------------------------------------------------------");
        System.out.println(
